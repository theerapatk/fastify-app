...
const authRouters = async (
  ...
  app.post('/refresh-token', { schema: authSchema.refreshToken }, authHandler.refreshToken);
  app.post(
    '/email-reset-password',
    { schema: authSchema.emailResetPassword },
    authHandler.emailResetPassword
  );
  app.post('/reset-password', { schema: authSchema.resetPassword }, authHandler.resetPassword);
};
